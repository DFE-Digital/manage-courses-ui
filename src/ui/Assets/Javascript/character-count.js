;(function (global) {
    ...
    if (countElements) {
      for (var i = 0, len = countElements.length; i < len; i++) {
        ...
        if (options && options.highlight) {
          ...
          wrapper.insertAdjacentHTML('afterbegin', '<div id="' + elementId + '-hl" class="govuk-form-control ' + countHighlightClass + '" aria-hidden="true" role="presentation"></div>')
  ...
  CharCount.prototype.createCountMessage = function (countElement) {
    ...
    if (elementId && !countMessage) {
      countElement.insertAdjacentHTML('afterend', '<span id="' + elementId + '-info" class="govuk-hint govuk-c-charcount__message" aria-live="polite"></span>')
  ...
  CharCount.prototype.bindChangeEvents = function (countElementExtended) {
    ...
    //   CharCount.prototype.updateCountMessage(countElementExtended);
    // });
    countElementExtended.countElement.addEventListener('blur', CharCount.prototype.updateCountMessage.bind(countElementExtended))
