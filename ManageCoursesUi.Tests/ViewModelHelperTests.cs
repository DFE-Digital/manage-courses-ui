...
namespace ManageCoursesUi.Tests
{
    ...
    class ViewModelHelperTests
    {
        ...
        [TestCase("N", "R", "N", "N", "N", "Needs attention in UCAS")]
        [TestCase("N", "N", "R", "N", "N", "Needs attention in UCAS")]
        [TestCase("N", "N", "N", "R", "N", "Needs attention in UCAS")]
        [TestCase("N", "N", "N", "N", "R", "Needs attention in UCAS")]
        [TestCase("N", "r", "n", "n", "n", "Needs attention in UCAS")]
        [TestCase("N", "n", "r", "n", "n", "Needs attention in UCAS")]
        [TestCase("N", "n", "n", "r", "n", "Needs attention in UCAS")]
        [TestCase("N", "n", "n", "n", "r", "Needs attention in UCAS")]
        [TestCase("N", "R", "", "", "N", "Needs attention in UCAS")]
        [TestCase("N", "R", "S", "D", "D", "Needs attention in UCAS")]
        [TestCase("N", "R", "S", "D", "N", "Needs attention in UCAS")]
        [TestCase("N", "r", "s", "d", "d", "Needs attention in UCAS")]
        [TestCase("N", "r", "s", "d", "n", "Needs attention in UCAS")]
        [TestCase("n", "R", "N", "N", "N", "Needs attention in UCAS")]
        [TestCase("n", "N", "R", "N", "N", "Needs attention in UCAS")]
        ...
        [TestCase("Y", "r", "Running")]
        [TestCase("y", "r", "Running")]
        [TestCase("N", "R", "Needs attention in UCAS")]
        [TestCase("n", "R", "Needs attention in UCAS")]
        [TestCase("N", "r", "Needs attention in UCAS")]
        [TestCase("n", "r", "Needs attention in UCAS")]
        [TestCase("", "R", "Needs attention in UCAS")]
        [TestCase("", "R", "Needs attention in UCAS")]
        [TestCase("", "r", "Needs attention in UCAS")]
        [TestCase("", "r", "Needs attention in UCAS")]
